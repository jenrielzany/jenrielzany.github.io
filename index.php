		...
		<nav id="slide-menu">
			  <ul>
			  	<h1 class="orange-title wow fadeInLeft"><i class="fa fa-tasks"></i>MAIN MENU</h1>
			  		<li class="wow fadeInLeft" data-wow-delay=".3s"> <a href="#home"><i class="fa fa-home"></i>Home</a> </li>
					<li class="wow fadeInLeft" data-wow-delay=".5s"> <a href="#works"><i class="fa fa-rocket"></i> Works</a> </li>
					<li class="wow fadeInLeft" data-wow-delay=".7s"> <a href="#about"><i class="fa fa-soccer-ball-o"></i>About Me</a> </li>
					<li class="wow fadeInLeft" data-wow-delay="1s"> <a href="#contact"><i class="fa fa-phone-square"></i>Contact</a> </li>
			  </ul>
			</nav>
			<!-- Content panel -->
			<div id="content">
